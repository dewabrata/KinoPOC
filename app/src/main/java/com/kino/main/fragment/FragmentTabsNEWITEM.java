...
public class FragmentTabsNEWITEM extends Fragment {
    private View parent_view;

    private RecyclerView recyclerView;
    private AdapterListProduct mAdapter;

    public FragmentTabsNEWITEM() {
    }
    private static String outletid,moduleid;
    public static FragmentTabsNEWITEM newInstance(String moduleid, String outletid) {

        FragmentTabsNEWITEM.moduleid = moduleid;
        FragmentTabsNEWITEM.outletid =outletid;
        FragmentTabsNEWITEM fragment = new FragmentTabsNEWITEM();
        return fragment;
    }
    ...
    private void getMarketList() {
        ...
        Call<Produk> produk = apiInterface.getProduk(outletid,moduleid,"3");
