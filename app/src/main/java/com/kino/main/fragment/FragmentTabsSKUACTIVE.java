...
public class FragmentTabsSKUACTIVE extends Fragment {
    ...
    public FragmentTabsSKUACTIVE() {
    }

    public static FragmentTabsSKUACTIVE newInstance(String moduleid, String outletid) {
        moduleid = moduleid;

        FragmentTabsSKUACTIVE.moduleid = moduleid;
        FragmentTabsSKUACTIVE.outletid =outletid;
        FragmentTabsSKUACTIVE fragment = new FragmentTabsSKUACTIVE();
        return fragment;
    }
    ...
    private void getMarketList() {
        ...
        Call<Produk> produk = apiInterface.getProduk(outletid,moduleid,"1");
